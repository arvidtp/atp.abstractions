...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 148.0, 320.0, 154.0 ],
					"text" : "Use with fingerpinger and atp.trackpadmapping for multitouch trackpads.\n\ninput 1: connect to atp.trackpadmapping outout\ninput 2: connect to fingerpinger right outlet\ninput 3 - change number of fingers to check for\n\nfirst two inputs are \n\nargument 1: How many fingers in contact to check for - default is 3"
				}
