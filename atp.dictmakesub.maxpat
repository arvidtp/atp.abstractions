...
, 			{
				"box" : 				{
					"comment" : "Change template subdict",
					"id" : "obj-18",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "Open template subdict",
					"id" : "obj-3",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 42.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.25, 78.0, 57.0, 18.0 ],
					"text" : "name $1"
				}
...
, 			{
				"box" : 				{
					"comment" : "Change target dict",
					"id" : "obj-5",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.25, 42.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "input to template subdict",
					"id" : "obj-9",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "attach to target dict (optional)",
					"id" : "obj-8",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 116.0, 105.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 251.0, 79.0, 21.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 207.0, 42.0, 21.0 ],
					"text" : "join 2"
				}
...
,
					"text" : "dict #0atp.dictmakesubTemplate"
				}

			}
, 			{
				"box" : 				{
					"comment" : "input name of subdict to create it",
					"id" : "obj-2",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 42.0, 25.0, 25.0 ]
				}
