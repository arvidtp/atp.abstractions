...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 10.0, 89.0, 20.0 ],
					"text" : "loadmess path"
				}
...
, 			{
				"box" : 				{
					"comment" : "Must connect to thispatcher input",
					"id" : "obj-142",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 109.5, 156.0, 24.0, 156.0, 24.0, 6.0, 109.5, 6.0 ],
					"source" : [ "obj-4", 0 ]
				}
